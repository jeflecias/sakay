...
def load_welcome(frame):
    ...
    label_2 = Label(center_frame, text="Ready to accept ride requests?", fg="#643602", bg="#D2B48C")
    label_3 = Label(center_frame, text="Go to Home to get started!", fg="#643602", bg="#D2B48C")
